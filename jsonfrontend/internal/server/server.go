...
// expires returns a time.Time value and expects current time and maxOffset in seconds as arguments.
// Returns current time + 1 second if 0 maxOffset, or a value between current and current + maxOffset.
