...
- Azure blob storage: Object store for the latest version of all the forecast data.
- Ecflow: Workflow manager for when and how to produce the forecast datasets.
- PPI: Compute, job scheduling and storage system for producing the forecast datasets. Storage system contains most of source data needed to produce the datasets.x
...
graph TD;
   ...
   subgraph Forti
      ...
      Correctedforecaster["Correctedforecaster<br>[Container: Go GRPC server]<br>Request forecast data, adjust and server."];
